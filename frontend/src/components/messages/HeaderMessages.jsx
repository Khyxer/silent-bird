...
import { NavMenuMainPage } from "@/components/main/NavMenuMainPage";
...
export const HeaderMessages = () => {
  ...
  return (
    <header className="flex  w-full h-15 border-b border-gray-color/50 bg-dark-color/80 backdrop-blur-lg z-90">
